            ...
            ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="status delivered"><a href="update.php?id=<?= $row['id'] ?>">Update</a></span></td>
                        <td><span class="status delete"><a href="delete.php?id=<?= $row['id'] ?>">Delete</a></span></td>
                    </tr>
